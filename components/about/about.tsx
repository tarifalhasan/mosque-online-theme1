            ...
            <Container>
                <div className="flex gap-10 lg:justify-between flex-col lg:flex-row lg:items-center">
                    <div className=" space-y-5 w-full lg:basis-1/2">
                        <div>
                            <p className="sub-heading text-left leading-tight ">Few Words About</p>
                            <h2 className="heading1 text-left leading-tight">History Of Center</h2>
                        </div>
                        <p className="text-base sm:text-lg font-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.
                        </p>
                        <span className=" block font-bold">The Mosque is the #1 Islamic Center in the Country!</span>
                    ...
                    <div>
                        <Image className=" max-w-[523.18px] max-h-[523.18px] w-full h-full object-cover" src={history_image} alt="history" />
                    </div>
                </div>
            </Container>
        </section>
